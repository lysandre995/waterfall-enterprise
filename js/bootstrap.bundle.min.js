...
!(function (t, e) {
        ...
        r = t =>
            o(t) ?
                t.jquery ?
                    t[0]
                :   t
            : "string" == typeof t && t.length > 0 ? document.querySelector(n(t))
            : null,
        a = t => {
    ...
    N.on(document, yt, "[data-bs-slide], [data-bs-slide-to]", function (t) {
        ...
        return (
            n ? (i.to(n), void i._maybeEnableCycle())
            : "next" === F.getDataAttribute(this, "slide") ? (i.next(), void i._maybeEnableCycle())
    ...
    function Ze(t) {
        return (
            ["html", "body", "#document"].indexOf(pe(t)) >= 0 ? t.ownerDocument.body
            : _e(t) && Je(t) ? t
            : Ze($e(t))
        );
    }
                    ...
                    setOptions: function (i) {
                        ...
                        d(),
                            ...
                            (a.scrollParents = {
                                reference:
                                    ge(t) ? ti(t)
                                    : t.contextElement ? ti(t.contextElement)
                                    : [],
                                popper: ti(e)
                            });
                        var r,
    ...
    class Ki extends W {
        ...
        _createPopper() {
            ...
            : o(this._config.reference) ? (t = r(this._config.reference))
    ...
    class rn extends H {
        ...
        _handleFocusin(t) {
            ...
            0 === i.length ? e.focus()
            : this._lastTabNavDirection === nn ? i[i.length - 1].focus()
            : i[0].focus();
        }
        _handleKeydown(t) {
        ...
        _setContent(t, e, i) {
            ...
            n
                && ((e = this._resolvePossibleFunction(e)) ?
                    o(e) ? this._putElementInTemplate(r(e), n)

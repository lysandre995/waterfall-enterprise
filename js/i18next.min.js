!(function (e, t) {
    ...
    const e = e => "string" == typeof e,
        ...
        r = (t, s, i) => {
            ...
            for (; a < r.length - 1; ) {
                if (n(t)) return {};
                const e = o(r[a]);
                !t[e] && i && (t[e] = new i()), (t = Object.prototype.hasOwnProperty.call(t, e) ? t[e] : {}), ++a;
            }
        ...
        u = e => e.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
    var g = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "/": "&#x2F;" };
    const p = t => (e(t) ? t.replace(/[&<>"'\/]/g, e => g[e]) : t);
    const c = [" ", ",", "?", "!", ";"],
        d = new (class {
            constructor(e) {
    ...
    class k extends b {
        ...
        getResource(t, s, i) {
            ...
            :   ((a = [t, s]),
                i
                    && (Array.isArray(i) ? a.push(...i)
                    : e(i) && n ? a.push(...i.split(n))
                    : a.push(i)));
            const h = l(this.data, a);
            return (
                !h && !s && !i && t.indexOf(".") > -1 && ((t = a[0]), (s = a[1]), (i = a.slice(2).join("."))),
                !h && r && e(i) ? f(this.data?.[t]?.[s], i, n) : h
            );
        }
        addResource(e, t, s, i) {
        ...
        addResources(t, s, i) {
            let o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : { silent: !1 };
            for (const o in i) (e(i[o]) || Array.isArray(i[o])) && this.addResource(t, s, o, i[o], { silent: !0 });
    ...
    class w extends b {
        ...
        exists(e) {
            const t = { ...(arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { interpolation: {} }) };
            if (null == e) return !1;
        ...
        extractFromKey(t, s) {
            ...
            const r = i && t.indexOf(i) > -1,
                a = !(
                    ...
                    || ((e, t, s) => {
                        (t = t || ""), (s = s || "");
                        const i = c.filter(e => t.indexOf(e) < 0 && s.indexOf(e) < 0);
            ...
            if (r && !a) {
                ...
                const r = t.split(i);
                (i !== o || (i === o && this.options.ns.indexOf(r[0]) > -1)) && (n = r.shift()), (t = r.join(o));
            }
        ...
        translate(t, s, i) {
            ...
            const d = p?.usedKey || a,
                ...
                x = w.hasDefaultValue(o),
                b = v ? this.pluralResolver.getSuffix(u, o.count, o) : "",
                k = o.ordinal && v ? this.pluralResolver.getSuffix(u, o.count, { ordinal: !1 }) : "",
                S = v && !o.ordinal && 0 === o.count,
                O =
                    (S && o[`defaultValue${this.options.pluralSeparator}zero`])
                    || o[`defaultValue${b}`]
                    || o[`defaultValue${k}`]
                    || o.defaultValue;
            let $ = c;
            y && !c && x && ($ = O);
            const R = L($),
                C = Object.prototype.toString.apply($);
            if (
                !(y && $ && R && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(C) < 0)
                || (e(m) && Array.isArray($))
            )
                if (y && e(m) && Array.isArray(c)) (c = c.join(m)), c && (c = this.extendTranslation(c, t, o, i));
                else {
                    let e = !1,
                        s = !1;
                    !this.isValidLookup(c) && x && ((e = !0), (c = O)), this.isValidLookup(c) || ((s = !0), (c = a));
                    const n =
                            (o.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && s ?
                                void 0
                            :   c,
                        l = x && O !== c && this.options.updateMissing;
                    if (s || e || l) {
                        if ((this.logger.log(l ? "updateKey" : "missingKey", u, h, a, l ? O : c), r)) {
                    ...
                    (c = this.extendTranslation(c, t, o, p, i)),
                        s && c === a && this.options.appendNamespaceToMissingKey && (c = `${h}:${a}`),
                        (s || e)
                            && this.options.parseMissingKeyHandler
                            && (c = this.options.parseMissingKeyHandler(
                                this.options.appendNamespaceToMissingKey ? `${h}:${a}` : a,
                                e ? c : void 0,
                                o
                            ));
                }
                ...
                if (!o.returnObjects && !this.options.returnObjects) {
                    ...
                    const e =
                        this.options.returnedObjectHandler ?
                            this.options.returnedObjectHandler(d, $, { ...o, ns: l })
                        :   `key '${a} (${this.language})' returned an object instead of string.`;
                    return n ? ((p.res = e), (p.usedParams = this.getUsedParamsDetails(o)), p) : e;
                }
                if (r) {
            ...
            return n ? ((p.res = c), (p.usedParams = this.getUsedParamsDetails(o)), p) : c;
        }
        extendTranslation(t, s, i, o, n) {
            ...
            if (this.i18nFormat?.parse)
                ...
                if (
                    ...
                    (t = this.interpolator.interpolate(t, h, i.lng || this.language || o.usedLng, i)),
                    a)
                ) {
                    const e = t.match(this.interpolator.nestingRegexp);
        ...
        resolve(t) {
            ...
            return (
                ...
                t.forEach(t => {
                    ...
                    const g = void 0 !== a.count && !e(a.count),
                        p = g && !a.ordinal && 0 === a.count,
                        c = void 0 !== a.context && (e(a.context) || "number" == typeof a.context) && "" !== a.context,
                        d =
                            a.lngs ?
                                a.lngs
                    ...
                    u.forEach(e => {
                        this.isValidLookup(s)
                            ...
                            O[`${d[0]}-${e}`]
                                ...
                                || ((O[`${d[0]}-${e}`] = !0),
                                this.logger.warn(
                                    `key "${i}" for languages "${d.join(", ")}" won't get resolved as namespace "${r}" was not yet loaded`,
                            ...
                            d.forEach(t => {
                                ...
                                n = t;
                                const i = [h];
                                if (this.i18nFormat?.addLookupKeys) this.i18nFormat.addLookupKeys(i, h, t, e, a);
                                else {
                                    let e;
                                    g && (e = this.pluralResolver.getSuffix(t, a.count, a));
                                    ...
                                    if (
                                        ...
                                        i.push(t),
                                            g
                                                ...
                                                a.ordinal
                                                    && 0 === e.indexOf(o)
                                                    && i.push(t + e.replace(o, this.options.pluralSeparator)),
                                                p && i.push(t + s));
                                    }
                                }
                                let r;
                                for (; (r = i.pop()); )
                                    this.isValidLookup(s) || ((o = r), (s = this.getResource(t, e, r, a)));
                            }));
                    });
                }),
        ...
        static hasDefaultValue(e) {
            ...
            for (const s in e)
                if (Object.prototype.hasOwnProperty.call(e, s) && t === s.substring(0, 12) && void 0 !== e[s])
                    return !0;
            return !1;
        }
    }
                ...
                !t
                    ...
                    && e.forEach(e => {
                        ...
                        t = this.options.supportedLngs.find(e =>
                            e === i ? e
                            : e.indexOf("-") < 0 && i.indexOf("-") < 0 ? void 0
                            : (
                                (e.indexOf("-") > 0 && i.indexOf("-") < 0 && e.substring(0, e.indexOf("-")) === i)
    ...
    class E {
        ...
        init() {
            ...
            (this.escape = void 0 !== t ? t : p),
                ...
                (this.nestingPrefix = c ? u(c) : d || u("$t(")),
                (this.nestingSuffix = f ? u(f) : m || u(")")),
        ...
        interpolate(t, i, o, n) {
            ...
            const h = (this.options && this.options.interpolation && this.options.interpolation.defaultVariables) || {},
                u = e => {
                    if (e.indexOf(this.formatSeparator) < 0) {
                        ...
                        return this.alwaysFormat ? this.format(t, void 0, o, { ...n, ...i, interpolationkey: e }) : t;
                    }
                    const t = e.split(this.formatSeparator),
                        s = t.shift().trim(),
                        r = t.join(this.formatSeparator).trim();
                    return this.format(N(i, h, s, this.options.keySeparator, this.options.ignoreJSONStructure), r, o, {
                        ...n,
                        ...i,
                        interpolationkey: s
                    });
            ...
            this.resetRegExp();
            const g = n?.missingInterpolationHandler || this.options.missingInterpolationHandler,
                p =
            ...
            return (
                [
                    { regex: this.regexpUnescape, safeValue: e => j(e) },
                    { regex: this.regexp, safeValue: e => (this.escapeValue ? j(this.escape(e)) : j(e)) }
                ].forEach(i => {
                    for (l = 0; (r = i.regex.exec(t)); ) {
                        ...
                        if (((a = u(o)), void 0 === a))
                            if ("function" == typeof g) {
                                ...
                                this.logger.warn(`missed to pass in variable ${o} for interpolating ${t}`), (a = "");
                            }
        ...
        nest(t, i) {
            ...
            for (; (o = this.nestingRegexp.exec(t)); ) {
                ...
                if (((n = i(l.call(this, o[1].trim(), r), r)), n && o[0] === t && !e(n))) return n;
                e(n) || (n = s(n)),
                    n || (this.logger.warn(`missed to resolve ${o[1]} for nesting ${t}`), (n = "")),
                    u
                        && (n = h.reduce(
                            (e, t) => this.format(e, t, a.lng, { ...a, interpolationkey: o[1].trim() }),
                            n.trim()
                        )),
                    (t = t.replace(o[0], n)),
            ...
            return o.reduce((e, t) => {
                const { formatName: o, formatOptions: n } = (e => {
                    ...
                    if (e.indexOf("(") > -1) {
                        ...
                        "currency" === t && o.indexOf(":") < 0 ? s.currency || (s.currency = o.trim())
                        : "relativetime" === t && o.indexOf(":") < 0 ? s.range || (s.range = o.trim())
                        : o.split(";").forEach(e => {
                                if (e) {
                                    const [t, ...i] = e.split(":"),
                                        o = i
    ...
    class A extends b {
        ...
        read(e, t, s) {
            ...
            if (this.readingCalls >= this.maxParallelReads)
                return void this.waitingReads.push({ lng: e, ns: t, fcName: s, tried: i, wait: o, callback: n });
            this.readingCalls++;
            const r = (r, a) => {
    ...
    class K extends b {
        ...
        init() {
            ...
            (this.isInitializing = !0),
                ...
                null == i.defaultNS
                    && i.ns
                    && (e(i.ns) ? (i.defaultNS = i.ns) : i.ns.indexOf("translation") < 0 && (i.defaultNS = i.ns[0]));
            const n = D();
            (this.options = { ...n, ...this.options, ...T(i) }),
                (this.options.interpolation = { ...n.interpolation, ...this.options.interpolation }),
                void 0 !== i.keySeparator && (this.options.userDefinedKeySeparator = i.keySeparator),
                void 0 !== i.nsSeparator && (this.options.userDefinedNsSeparator = i.nsSeparator);
            const r = e =>
                e ?
                    "function" == typeof e ?
                        new e()
            ...
            if (!this.options.isClone) {
                ...
                (i.logger = x),
                    ...
                    (i.interpolator = new E(this.options)),
                    (i.utils = { hasLoadedNamespace: this.hasLoadedNamespace.bind(this) }),
                    (i.backendConnector = new A(r(this.modules.backend), i.resourceStore, i, this.options)),
        ...
        loadResources(t) {
            ...
            if (("function" == typeof t && (s = t), !this.options.resources || this.options.partialBundledLanguages)) {
                if ("cimode" === i?.toLowerCase() && (!this.options.preload || 0 === this.options.preload.length))
                    return s();
                const e = [],
                    t = t => {
                        if (!t) return;
                ...
                this.options.preload?.forEach?.(e => t(e)),
                    this.services.backendConnector.load(e, this.options.ns, e => {
                        e || this.resolvedLanguage || !this.language || this.setResolvedLanguage(this.language), s(e);
                    });
            } else s(null);
        }
        ...
        getFixedT(t, s, i) {
            ...
            const n = function (e, t) {
                ...
                return (
                    (u =
                        s.keyPrefix && Array.isArray(e) ? e.map(e => `${s.keyPrefix}${h}${e}`)
                        : s.keyPrefix ? `${s.keyPrefix}${h}${e}`
                        : e),
                    o.t(u, s)
                );
            };
            return e(t) ? (n.lng = t) : (n.lngs = t), (n.ns = s), (n.keyPrefix = i), n;
        }
        t() {
            for (var e = arguments.length, t = new Array(e), s = 0; s < e; s++) t[s] = arguments[s];
        ...
        loadLanguages(s, i) {
            ...
            const n = this.options.preload || [],
                r = s.filter(e => n.indexOf(e) < 0 && this.services.languageUtils.isSupportedCode(e));
            return r.length ?
        ...
        cloneInstance() {
            ...
            return (
                (o.translator = new w(o.services, i)),
    ...
    const U = K.createInstance();
    return (U.createInstance = K.createInstance), U;
});
